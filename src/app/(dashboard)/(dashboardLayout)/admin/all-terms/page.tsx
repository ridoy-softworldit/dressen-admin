...
import { useGetAllTermsQuery } from "@/redux/featured/terms/termApi";

export default function FaqTableOnly() {
  const { data: faqData = [], isLoading, isError } = useGetAllTermsQuery();
      ...
      <Card className="p-6 rounded-xl">
        ...
        <div className="rounded-md overflow-hidden border-b">
          <Table>
            <TableHeader>
              <TableRow>
                <TableHead className="text-[#979797]">Name</TableHead>
              ...
              {isLoading ? (
                ...
                filteredFaqs.map((faq: any) => (
                  <TableRow key={faq._id}>
                    <TableCell className="py-4">{faq.name}</TableCell>
